...
exports.config = {
    ...
    // Specify Test Files
    // ==================
    // Define which wdio specs should run. The pattern is relative to the directory
    ...
    // time. Depending on the number of capabilities, WebdriverIO launches several wdio
    ...
    // from the same wdio should run tests.
    //
    maxInstances: 10,
    //
    ...
    // Hooks
    // =====
    // WebdriverIO provides several hooks you can use to interfere with the wdio process in order to enhance
    ...
    // },
    /**
     * Gets executed just before initialising the webdriver session and wdio framework. It allows you
    ...
    // },
    /**
     * Gets executed before wdio execution begins. At this point you can access to all global
    ...
    // },
    /**
     * Function to be executed before a wdio (in Mocha/Jasmine) starts.
     */
    // beforeTest: function (wdio, context) {
    // },
    /**
     * Hook that gets executed _before_ a hook within the suite starts (e.g. runs before calling
     * beforeEach in Mocha)
     */
    // beforeHook: function (wdio, context) {
    // },
    /**
     ...
     * the wdio.
     * @param {Number} result 0 - wdio pass, 1 - wdio fail
     * @param {Array.<Object>} capabilities list of capabilities details
     ...
     * thrown in the onComplete hook will result in the wdio run failing.
